...
"""
WIKI_LINK      =  "https://github.com/russ-hensel/pyqt_by_example/wiki/Building-a-GUI-Desktop-Calculator"
...
def move_under_mouse( widget ):
    ...
    # Move the window so its top-left corner is at the mouse
...
class ExampleWindow( QWidget ):
    def __init__(self, tab,  build_method ):
        ...
        basics, not sure why we do not just have separate
        windows
    ...
    def build_calc( self, ):
       ...
       #                            "work still to be done on this exercise " ]
