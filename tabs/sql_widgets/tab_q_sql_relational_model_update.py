...
TAB_TITLE:       QSqlRelationalTableModel / Update in dev
...
"""
WIKI_LINK      =  "https://github.com/russ-hensel/pyqt_by_example/wiki/What-We-Know-About-QSqlRelationalTableModel-with-Update"
...
#-----------------------------------------------
class QSqlRelationalTableModelUpdateTab( tab_base.TabBase  ):
    """
